...
bool ImProcFunctions::localContrast(Imagefloat *rgb)
{
    ...
    if (params->localContrast.enabled) {
        ...
        if (!generateLabMasks(rgb, params->localContrast.labmasks, offset_x, offset_y, full_width, full_height, scale, multiThread, show_mask_idx, &mask, nullptr, cur_pipeline == Pipeline::NAVIGATOR ? plistener : nullptr)) {
